...
export default function SKRCard({ holding, income, onEdit }: SKRCardProps) {
  ...
  return (
    <View style={styles.card}>
      ...
      {/* Stake link */}
      <TouchableOpacity
        style={[styles.actionBtn, styles.stakeBtn, { marginTop: 4 }]}
        onPress={() => Linking.openURL('https://stake.solanamobile.com/')}
      >
        <Text style={styles.actionBtnText}>Stake / Unstake on Solana Mobile</Text>
      </TouchableOpacity>
    </View>
  );
}
