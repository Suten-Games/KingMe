...
import { TRANSACTION_GROUP_META } from '../types/bankTransactionTypes';

interface Props {
  cashFlow: OverallCashFlow;
}

// All category groups for re-categorization.
// Non-variable groups (housing, utilities, insurance, subscriptions, financial, transfers)
// will remove the transaction from variable spending when assigned.
