...
export const TOKEN_REGISTRY: Record<string, TokenInfo> = {
  ...
  JUPSOL: {
    ...
    logoURI: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/27G8MtK7VtTcCHkpASjSDdkWWYfoqT6ggEuKidVJidD4/logo.png',
  ...
  'USD*': {
    symbol: 'USD*',
    name: 'USD* (Perena)',
    logoURI: 'https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/star9agSpjiFe3M49B3RniVU4CMBBEK3Qnaqn3RGiFM/logo.png',
    mint: 'star9agSpjiFe3M49B3RniVU4CMBBEK3Qnaqn3RGiFM',
    coingeckoId: 'perena-usd',
  },
  BSOL: {
    symbol: 'bSOL',
