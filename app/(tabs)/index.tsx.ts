...
export interface CryptoAsset {
  ...
  // DeFi leverage position fields
  supplied?: number;      // Total collateral value (e.g. $536 INF)
  borrowed?: number;      // Total borrowed value (e.g. $399 wSOL)
  leverage?: number;      // Multiplier (e.g. 3.9)
  healthFactor?: number;  // Health % (e.g. 22)
  positionType?: 'token' | 'staking' | 'lending' | 'loop' | 'lp' | 'vault';
}
